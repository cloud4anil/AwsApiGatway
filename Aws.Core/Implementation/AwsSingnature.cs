...
namespace Aws.Core.Implementation
{
    public class AWS4RequestSigner: IAwsRequestSigner
    {
        ...
        public AWS4RequestSigner():this("_accessKey", "_secretKey")
        {
        ...
        public async Task<HttpRequestMessage> Sign(HttpRequestMessage request, string service, string region)
        {
            ...
            {
                throw new ArgumentNullException(nameof(service), "Not a valid service.");
            }
            if (string.IsNullOrEmpty(region))
            {
                throw new ArgumentNullException(nameof(region), "Not a valid region.");
            }
            if (request == null)
            {
